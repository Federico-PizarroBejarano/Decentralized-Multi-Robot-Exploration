...
class RobotTeam:
    ...
    def explore(self, world):
        ...
        with open('./decentralized_exploration/results/two_robots_map_4/mdp_blocked_ind.pkl', 'rb') as infile:
            all_results = pickle.load(infile)
        
        all_results.append(np.array(explored_per_iteration))

        with open('./decentralized_exploration/results/two_robots_map_4/mdp_blocked_ind.pkl', 'wb') as outfile:
